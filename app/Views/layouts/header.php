<header class="fixed top-0 left-0 bg-neutral-50 w-full py-4 px-7 flex justify-between items-center border-b border-solid border-neutral-300 z-999999999">
    <!-- Identity Company -->
    ...
    <!-- Navigasi -->
    <nav class="relative flex gap-8 text-gray-500/90">
        <a href="<?= base_url('/') ?>" class="active hover:text-blue-500 focus:outline-0">Beranda</a>
        <a href="#" class="hover:text-blue-500 focus:outline-0">Profil</a>
        <div class="list-dropdown relative">
            <a href="javascript:void(0)" class="flex items-center gap-0.5 hover:text-blue-500 focus:outline-0">
                Daftar Anggota
